...
player package/class specifications (positional arguments):
  ...
  your top-level package (i.e. 'midnight').
  ...
  with import statements, e.g. 'midnight.player2') or relative path (to a
  file or directory containing the Python module, e.g. 'midnight/player3'
  or 'midnight/players/player4.py').
